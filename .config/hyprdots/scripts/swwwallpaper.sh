...
lockFile="/tmp/hyrpdots$(id -u)awwwallpaper.lock"
...
wallTmb="${XDG_CONFIG_HOME:-$HOME/.config}/awww/wall.thmb"
wallDcl="${XDG_CONFIG_HOME:-$HOME/.config}/awww/wall.dcol"
